...
from ShinobiCompass.modules.pawn import sell_command, scroll_command, handle_category_selection
...
application.add_handler(CommandHandler("linv", submit_inventory))
